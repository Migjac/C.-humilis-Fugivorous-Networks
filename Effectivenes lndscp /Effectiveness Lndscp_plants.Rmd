...
mtsg_fruits_long$Sum_f<-mtsg_fruits_sum
...
p1<-effectiveness_plot(q1=mrt_total$sum,q2=mrt_total$fruit_mean, pts.color= mrt_total$motif,pts.size=4, nlines=20,
...
p2<-effectiveness_plot(q1=mtsg_total$sum,q2=mtsg_total$fruit_mean, pts.color= mtsg_total$combination,pts.size=4, nlines=16,
                       myxlab= "Visit rate (/day)",

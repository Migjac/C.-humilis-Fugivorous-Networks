...
p1<-effectiveness_plot(q1=mrt_total$visit_mean,q2=mrt_total$fruit_mean, pts.color= mrt_total$motif,pts.size=3, nlines=9,
                       myxlab= "Visit/day",
                       myylab="Fruit removal/day")


p2<-effectiveness_plot(q1=mtsg_total$visit_mean,q2=mtsg_total$fruit_mean, pts.color= mtsg_total$motif,pts.size=3, nlines=9,
                       myxlab= "Visit/day",
                       myylab="Fruit removal/day")


p3<-effectiveness_plot(q1=mm_total$visit_mean,q2=mm_total$fruit_mean, pts.color=mm_total$pop, pts.size=3, nlines=9,
                       myxlab= "Visit/day",
                       myylab="Fruit removal/day")

p4<-effectiveness_plot(q1=mm_total$visit_mean,q2=mm_total$fruit_mean, pts.shape = mm_total$pop, pts.color=mm_total$motif, pts.size=3, nlines=12,
                       myxlab= "Visit/day",
                       myylab="Fruit removal/day")

...
#Both poulations
mart_matas_fruits<-read.csvread.csv("~/Desktop/Palmito/Postdoc-Interaction Networks/C.-humilis-Fugivorous-Networks/Fruit removal/mart_matas_fruits.csv",header=TRUE,check.names=FALSE,row.names=1)
...
mart_elong<-mutate(mart_elong,
     i_group = if_else( animal == "deer","Seed-Predator", if_else(animal == "wild", "Seed-Predator", if_else(animal == "rabbit", "Deflesher", if_else(animal == "rat", "Deflesher", if_else(animal == "fox", "Seed-Disperser", if_else( animal == "badger", "Seed-Disperser", "ERROR" )))))))
...
mart_effect<-effectiveness_plot(q1=mart_elong$Effectiveness,q2=mart_elong$recruit, pts.color=mart_elong$i_group,label=mart_elong$animal, nlines=10,
                       myxlab= "Handled fruits/Visit",
                       myylab="Plant recruitment")

matas_effect<-effectiveness_plot(q1=matas_elong$Effectiveness,q2=matas_elong$recruit, pts.color=matas_elong$i_group,label=matas_elong$animal, nlines=16,
                       myxlab= "Handled fruits/Visit",
                       myylab="Plant recruitment")
```

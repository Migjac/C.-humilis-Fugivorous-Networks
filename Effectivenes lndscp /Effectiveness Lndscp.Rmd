...
```{r}
###Both populations
mart_matas_e<-read.csvread.csv("~/Desktop/Palmito/Postdoc-Interaction Networks/C.-humilis-Fugivorous-Networks/Frugivore Efficiency/mart_matas_eff.csv",header=TRUE,check.names=FALSE,row.names=1)

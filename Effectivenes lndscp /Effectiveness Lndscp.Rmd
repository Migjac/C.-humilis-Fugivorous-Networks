...
mm_fruits_long$SE_f<-mm_fruits_sd/sqrt(length(mm_visits_mean)) #adding the values of standard deviation
...
p3<-effectiveness_plot(q1=mm_total$visit_mean,q2=mm_total$fruit_mean, q1.error =mm_total$SE, q2.error = mm_total$SE_f, pts.color=mm_total$i_group,label=mm_total$animal, nlines=8,                       myxlab= "No. visits/10d", 
                      myylab="Proportion of fruits handled")
                      p3+ ggtitle("Dwarf palm frugivorous")

...
levels(total$variable)[levels(total$variable)=="ant-absent_mut-strong"]<-"S-Mutualism"
levels(total$variable)[levels(total$variable)=="ant-absent_mut-weak"]<-"W-Mutualism"
levels(total$variable)[levels(total$variable)=="ant-strong_mut-absent"]<-"S-Antagonism"
levels(total$variable)[levels(total$variable)=="ant-strong_mut-strong"]<-"S-Mutualism / S-Antagonism"
levels(total$variable)[levels(total$variable)=="ant-strong_mut-weak"]<-"W-Mutualism / S-Antagonism"
levels(total$variable)[levels(total$variable)=="ant-weak_mut-absent"]<-"W-Antagonism"
levels(total$variable)[levels(total$variable)=="ant-weak_mut-strong"]<-"S-Mutualism / W-Antagonism"
levels(total$variable)[levels(total$variable)=="ant-weak_mut-weak"]<-"W-Mutualism / W-Antagonism"
...
ggplot(total,aes(x=variable,y=value, fill=Data))+
  ...
  geom_errorbar(aes(ymin=value-SD, ymax=value+SD),
                  ...
                  position=position_dodge(.9))+scale_x_discrete(limits= c("Abs", "S-Mutualism", "W-Mutualism","S-Mutualism / W-Antagonism", "S-Mutualism / S-Antagonism", "W-Mutualism / W-Antagonism","W-Mutualism / S-Antagonism","W-Antagonism", "S-Antagonism"))+ theme(axis.text.x = element_text(angle = 60, hjust = 1))+scale_fill_manual(values = c("black", "white"))+ theme(

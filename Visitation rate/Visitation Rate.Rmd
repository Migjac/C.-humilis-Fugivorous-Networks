...
```
Modularity in Matasgordas is higher (0.375) than Martinazo (0.285)
...
par(mfrow=c(1,1))
mart_matas_visit<-read.csv("~/Desktop/Palmito/Postdoc-Interaction Networks/C.-humilis-Fugivorous-Networks/Visitation rate/mart_mat_visit.csv",header=TRUE,check.names=FALSE,row.names=1)
plotweb(mart_matas_visit, col.low=c(gray(seq(0.1,1,length=63))),col.high=c("white","white","gray30","gray30","black","black","darkgray"),method="normal", text.rot=90,low.lablength=10, high.lablength=8)
```
&nbsp;

...
#Mean recruitment by standardized traits
fe_glm<-glm(mean_eff~inf_s+norm_d+size_s+sincr_s+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s,data = mart_matas_e)
fe_glm
summary(fe_glm)
...
#Mean recruitment by motif and standardized traits
...
fe_glmm2<-lmer(mean_eff~inf_s+size_s+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s+(1 | pop),data = mart_matas_e)
fe_glmm2
summary(fe_glmm2)
...
fe_glmm3<-lmer(mean_eff~inf_s+motif+size_s+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s+(1 | pop),data = mart_matas_e)
fe_glmm3
summary(fe_glmm3)
...
net_glmm1<-glm(norm_d~inf_s+size_s+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s,data = mart_matas_e)
net_glmm1
summary(net_glmm1)
...
net_glmm2<-glm(spp_str~inf_s+size_s+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s,data = mart_matas_e)
net_glmm2
summary(net_glmm2)
...
#With motifs
net_glmm3<-glm(norm_d~inf_s+size_s+motif+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s,data = mart_matas_e)
net_glmm3
summary(net_glmm3)
...
net_glmm4<-glm(spp_str~inf_s+size_s+motif+fruits_s+fruit_set_s+del.area_s+nn_s+dens_s,data = mart_matas_e)
net_glmm4
summary(net_glmm4)

...
mart_mux<-mart_mux[,c(9,2,3,4,5,6,7,8,1)]

mart_mux1<-mart_rec
mart_mux1["node_plant"]<-1:24
mart_mux1<-mart_mux1[,c(8,2,3,4,5,6,7,1)]
...
matas_mux<-matas_mux[,c(9,2,3,4,5,6,7,8,1)]

matas_mux1<-matas_rec
matas_mux1["node_plant"]<-1:46
matas_mux1<-matas_mux1[,c(8,2,3,4,5,6,7,1)]
...
write.table(mart_mux_lomg, "/Users/apple/desktop/Palmito/Postdoc-Interaction_Networks/C.-humilis-Fugivorous-Networks/muxViz-master/data/Multilayer_mart_2/multi_mart_mean.txt", col.names = FALSE, row.names = FALSE, sep = " ")
...
write.table(mata_mux_lomg, "/Users/apple/desktop/Palmito/Postdoc-Interaction_Networks/C.-humilis-Fugivorous-Networks/muxViz-master/data/Multilayer_matas_2/multi_mata0_1.txt", col.names = FALSE, row.names = FALSE, sep = " ")
```
